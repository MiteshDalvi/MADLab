...
class _SearchState extends State<Search> {
  ...
  getRecipes(String query) async {
    String url =
        "https://api.edamam.com/search?q=$query&app_id=2159af20&app_key=58924e51bb9295724d0a13dc230be5d4";
                                        ...
                                        child: Center(
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(recipeList[index].appcalories.toString().length > 6? recipeList[index].appcalories.toString().substring(0, 6): recipeList[index].appcalories.toString()),
